...
function Dialog({
  ...
  return /* @__PURE__ */ React.createElement(DialogCompositionContext.Provider, { value: contextValue }, /* @__PURE__ */ React.createElement(DialogPrimitive.Root, { "data-slot": "dialog", ...props }));
}
